...
data.angleBG_all(:,t:end)            = [];
data.angleFG_all(:,t:end)            = [];
data.stimID_all(:,t:end)             = [];
data.lineLengthID_all(:,t:end)       = [];
data.lineLength_inDeg_all(:,t:end)   = [];
data.lineLength_inPix_all(:,t:end)   = [];

data.precueLoc(t:end)                = [];
data.postcueLoc(t:end)               = [];
data.cueValidity(t:end)              = [];
data.stimID_postcue(t:end)           = [];
data.lineLengthID_postcue(t:end)     = [];
data.lineLength_inDeg_postcue(t:end) = [];
data.lineLength_inPix_postcue(t:end) = [];

data.ovalEccentricity(t:end)         = [];
