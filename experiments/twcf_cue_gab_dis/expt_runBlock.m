...
if setup.resumeDataset
    ...
    % initialize data
    [data, timing, gaze, progress] = expt_runBlock_initializeData(p, b, setup);
    pass = 1;
end
...
for i_block = init.i_block : b.nBlocks
    ...
    while ~isempty(indexQueue)
        ...
        [data, timing, gaze, exitNow] = expt_runTrial(w, p, b, data, timing, gaze, i_index, i_trial, setup);
...
[data, timing, gaze] = expt_runBlock_trimData(data, timing, gaze, setup);
