function [data, timing, gaze] = expt_runBlock_trimData(data, timing, gaze, setup)
...
% tilt
data.w_tilt(t:end)                   = []; 
data.tilt_inDeg(t:end)               = []; 

% response variables (button press 1) 
data.respDis(t:end)                  = [];
% data.respDet(t:end)                  = [];
