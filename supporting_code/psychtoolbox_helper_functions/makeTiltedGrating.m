function [grating, gaussianMask] = makeTiltedGrating(width,height,contrast,tiltInRadians,gratingPeriod,gratingPeriodUnits,nSD)
% [grating gaussianMask] = makeTiltedGrating(width,height,contrast,tiltInRadians,gratingPeriod,gratingPeriodUnits,nSD)
%
...
%       Default = 1
%
% tiltInRadians = tilt of grating from vertical orientation in radians.
%       e.g., 0    = vertical
%             pi/4 = 45 degrees
%             pi/2 = horizontal
%
...
%
% nSD = # of SDs spanned by Gaussian mask [default = 3]
