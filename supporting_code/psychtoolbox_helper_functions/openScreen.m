function [window,keyboardNumber,wRect,midW,midH] = openScreen(windowPtrOrScreenNumber, winFraction)
...
[w, h]=Screen('WindowSize',windowPtrOrScreenNumber);

if windowPtrOrScreenNumber == min(Screen('Screens'))
    [window,wRect] = Screen('OpenWindow', windowPtrOrScreenNumber, 0, winFraction*[0 0 w h]);
else
...
if IsOSX
    keyboardNumber = -1; % getKeyboardNumber; % temp fix
