function [grating gaussianMask] = makeGrating(width,height,contrast,gratingPeriod,gratingPeriodUnits,orientation,nSD)
% [grating gaussianMask] = makeGrating(width,height,contrast,gratingPeriod,gratingPeriodUnits,orientation)
%
